...
class ProductTabs extends Tabs
{
    ...
    {
        return tap(new Tab('preorder', trans('product::products.tabs.preorder')), function (Tab $tab) {

            $tab->weight(56);
            $tab->fields([ 'prepare_days', 'pre_short_description', 'is_active']);
            $tab->view('product::admin.products.tabs.preorder');
        });
    }
