    ...
    public function format($currency = null, $locale = null)
{
    ...
    if ($this->amount !== null) {
        ...
        // Handle the case where $this->amount is null
        // For example, you can throw an exception or provide a default value
      //  throw new \RuntimeException('$this->amount is null');
