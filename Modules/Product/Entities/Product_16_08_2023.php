...
class Product extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['brand_id', 'tax_class_id', 'slug', 'sku', 'price', 'special_price', 'special_price_type', 'special_price_start', 'special_price_end', 'selling_price', 'manage_stock', 'qty', 'in_stock', 'is_virtual', 'is_active', 'new_from', 'new_to','prepare_days'];
    ...
    protected $preorderAttributes = ['product_id','prepare_days', 'pre_short_description', 'is_preorder_status'];
...
// Use the toSql() method to get the actual SQL query
$sql = $query->toSql();
...
// $results = $query->get();
    ...
    {
        return $this->belongsToMany(static::class, 'preorder', 'product_id', 'prepare_days','short_description','is_preorder_status');
    }
    ...
    // public function preOrderProductList()
    // {
