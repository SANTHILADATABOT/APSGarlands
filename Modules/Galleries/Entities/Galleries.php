...
use Modules\Galleries\IconResolver;
use Modules\User\Entities\User;
use Modules\Galleries\Admin\GalleriesTable;
...
class Galleries extends Model
{
     ...
     * @var array
     */
    protected $visible = ['id', 'videoID','videoTitle', 'videoFullURL', 'channelTitle'];
    ...
    public function table($request)
    {
        ...
        return new GalleriesTable($query);
    }
}
