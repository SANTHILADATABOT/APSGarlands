        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th style="text-align:center">{{ trans('report::admin.table.orders') }}</th>
                    <th style="text-align:center">{{ trans('report::admin.table.products') }}</th>
                    <th style="text-align:center">{{ trans('report::admin.table.total') }}</th>
                </tr>
            </thead>
            ...
            <tbody>
                @forelse ($report as $data)
                    <tr>
                        ...
                        <td style="text-align:right">{{ $data->total_products }}</td>
                        <td style="text-align:right">{{ $data->total->format() }}</td>
                    </tr>
                @empty
                    <tr>
